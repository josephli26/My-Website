...
export function AboutView() {
  ...
  return (
    ...
    >
      ...
      ══════════════════════════════════════════ */}
      <section className="px-6 md:px-12 max-w-7xl mx-auto cms-section-gap">
        <div className="grid grid-cols-1 lg:grid-cols-[380px_1fr] gap-12 md:gap-20 items-start">
          {/* Picture wrap */}
          ...
          <motion.div
            ...
            className="flex flex-col text-left gap-6 pt-2"
          >
      ...
      ══════════════════════════════════════════ */}
      <section className="border-t border-white/5 py-12 bg-brand-black px-6">
        <motion.div
          variants={containerVariants}
          initial="hidden"
          whileInView="show"
      ...
      {/* ══════════════════════════════════════════
           MY CREATIVE TOOLBOX
      ══════════════════════════════════════════ */}
      <section className="border-t border-white/5 py-20 px-6 md:px-12 bg-brand-black/40">
