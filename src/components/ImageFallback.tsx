...
export function fixAssetUrl(url?: string): string {
  ...
  // Auto-map legacy GIF-274 path variations to organized folder
  if (
    clean === "GIF-274.gif" ||
    clean === "assets/GIF-274.gif" ||
    clean === "src/assets/GIF-274.gif" ||
    clean === "/src/assets/GIF-274.gif" ||
    clean === "assets/images/GIF-274.gif" ||
    clean === "/assets/images/GIF-274.gif" ||
    clean === "/src/assets/images/GIF-274.gif"
  ) {
    return "/src/assets/images/GIF-274.gif";
  }

  // Ensure leading slash for relative asset and upload paths so sub-routes work correctly
  if (!clean.startsWith("/")) {
    return "/" + clean;
  }
