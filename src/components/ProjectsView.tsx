...
const CATEGORIES = [
  ...
  { label: "UI Motion", value: "UI Motion" },
...
export function ProjectsView({ onSelectProject }: ProjectsViewProps) {
  ...
  // Distribute categories into 3 columns manually to match the vertical-first grid design in the user's image
  const column1 = [CATEGORIES[0], CATEGORIES[1], CATEGORIES[2]];
  const column2 = [CATEGORIES[3], CATEGORIES[4]];
  const column3 = [CATEGORIES[5], CATEGORIES[6]];
  ...
  return (
    <div className="w-full px-6 md:px-12 cms-page-padding">
      <style>{`
        .cms-page-padding {
