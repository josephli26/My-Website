...
export function Footer({ onNavigate }: FooterProps) {
  ...
  return (
    <footer className="w-full flex flex-col">
      ...
      <div className="bg-brand-footer text-brand-black py-10 px-6 md:px-12">
      ...
      <div className="bg-brand-black border-t border-white/5 py-6 px-6 md:px-12 text-white/50 text-[11px]">
